...
st.markdown('<div style="text-align: center;"><img src="st.markdown('<div style="text-align: center;"><img src="https://via.placeholder.com/200" alt="Company Logo" style="width: 200px;"/></div>', unsafe_allow_html=True)"
