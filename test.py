...
class RenderHTML:
    ...
    def improve_arrow_chart_content(self):
        ...
        return {
            # Updated Business Activity based on the company introduction
            "title1": self.arrow_chart.get('title1', 'Business Activity').title().strip(),
            "content1": f"{self.introduction}. This model helps the company in delivering high-quality services tailored to client needs.".title().strip(),
